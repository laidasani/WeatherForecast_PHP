 <?php  
	 //This is the script for populating the select of form
		//CHANGE THIS URL WHEN HOST ON Azure
		// $json_file=file_get_contents("http://localhost/HomeWork6/States.txt");
